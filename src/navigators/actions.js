...
import {TaskScreenType} from "../utils/GlobalData";
...
export const toWebViewComponent = (url) => ({
    type: NAV_TO_WEB_VIEW,
    url: url
});

export const toTuCaoWebView = (url) => ({
    type: NAV_TO_TUCAO_WEB_VIEW,
    url: url
});
